                ...
                <div className="flex items-start space-x-4">
                    <div className="flex-1 relative">
                        <textarea
                            ...
                            rows={1}
                            className={`w-full px-5 py-4 border border-gray-300 dark:border-dark-600 rounded-2xl resize-none focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent transition-all duration-200 scrollbar-hide ${disabled || isSubmitting
                    ...
                    <button
                        ...
                        disabled={!canSend}
                        className={`min-w-14 h-14 px-4 rounded-2xl font-medium transition-all duration-200 shadow-sm flex items-center justify-center flex-shrink-0 ${canSend
